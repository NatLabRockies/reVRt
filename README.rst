...
This is highly recommended as you will get the release build of the Rust code, which
is significantly faster than the debug build that is installed when building from source.
