...
def rasterize_shape_file(  # ruff:ignore[too-many-arguments, too-many-positional-arguments]
    fname,
    width,
    height,
    transform,
...
def rasterize(  # ruff:ignore[too-many-arguments, too-many-positional-arguments]
    gdf,
    width,
    height,
    transform,
